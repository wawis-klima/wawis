...
Wersja 11.08 zmniejsza nazwę klienta w mobilnych szczegółach, centruje adres oraz upraszcza i zagęszcza kafelki komentarzy.

# Wawis Klimatyzacja — wersja 11.08
...
## Ostatnia poprawka
- wersja `11.08` — zmniejszono nazwę klienta w mobilnych szczegółach, wyśrodkowano adres i uproszczono komentarze do jednego zwartego wiersza autora z przyciskiem `Usuń` po prawej.
