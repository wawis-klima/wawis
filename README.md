...
## Ostatnia poprawka
- wersja `10.78` — atomowa własność endpointu PUSH, lifecycle/generacja A→B, odrzucanie starych wiadomości w Service Workerze, retry cleanup po odzyskaniu sieci oraz uproszczony release bez Google Drive.
