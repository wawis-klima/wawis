...
# Wawis Klimatyzacja — wersja 10.65
...
## Ostatnia poprawka
- wersja `10.65` — Mobilny przycisk PW jest wyraźnie odsunięty od prawej krawędzi dzięki 24 px prawemu paddingowi całego paska akcji.
