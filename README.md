...
Wersja 11.12 automatycznie ponawia pobieranie szczegółów montażu i nie uruchamia sprawdzania protokołu równolegle ze zdjęciami.

# Wawis Klimatyzacja — wersja 11.12
...
## Ostatnia poprawka
- wersja `11.12` — szczegóły montażu mają automatyczną drugą próbę, a odczyt protokołu startuje dopiero po załadowaniu zdjęć i komentarzy; techniczny AbortError nie jest już pokazywany użytkownikowi.
