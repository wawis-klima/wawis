...
## Ostatnia poprawka
- wersja `10.77` — zabezpiecza protokoły PDF i zdjęcia licznika przed usunięciem po niejednoznacznym wyniku zapisu do bazy; pusty readback nie jest już traktowany jako dowód braku commitu.
