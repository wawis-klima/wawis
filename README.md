...
## Ostatnia poprawka
- wersja `11.11` — mobilne requesty Supabase szybciej kończą zawieszone połączenia, a miniatury automatycznie przechodzą na świeży link do oryginalnego zdjęcia bez ponownego logowania.
