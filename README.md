...
## Ostatnia poprawka
- wersja `10.76` — mobilny PUSH przy wylogowaniu: dezaktywacja przed usunięciem sesji, lokalny unsubscribe, trwały retry po awarii sieci i bezpieczny handoff endpointu A→B po zgodności kluczy Web Push.
