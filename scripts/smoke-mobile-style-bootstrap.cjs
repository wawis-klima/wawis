...
assert.match(main, /Promise\.all\([\s\S]*import\('\.\/mobile791\/App\.jsx'\)[\s\S]*import\('\.\/mobile791\/mobile\.css'\)[\s\S]*import\('\.\/mobile791\/styles\/desktop-jobs-table\.css'\)/, 'Mobilna aplikacja, główny CSS i CSS tabeli muszą być ładowane razem przed renderem.');
