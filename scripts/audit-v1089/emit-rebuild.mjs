...
if(ref!=='wnctellcoznmgwcpzztm'||!output)throw new Error('Usage: node scripts/audit-v1089/emit-rebuild.mjs wnctellcoznmgwcpzztm OUTPUT.sql; production forbidden');
