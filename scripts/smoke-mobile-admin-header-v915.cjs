...
assert.match(runtimeCss, /wawisOneLineToolbar\{[\s\S]*?box-sizing:border-box!important;[\s\S]*?padding-inline:2\.5px!important;/, 'Mobile toolbar must keep the reduced, equal 2.5 px edge inset on both sides.');
