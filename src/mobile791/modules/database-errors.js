...
export const SOURCE_JOB_ID_TEXT_HOTFIX_MESSAGE = [
  ...
  'Uruchom w Supabase SQL Editor najnowszy plik devices-module-stage-7-source-job-id-text-production-hotfix.sql z wersji 7.87 lub nowszej, potem odśwież aplikację i zapisz montaż ponownie.',
].join(' ');
