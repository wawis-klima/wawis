Warning: truncated output (original token count: 77999)
Total output lines: 3152
...
- po automatycznym zakończeniu fragmentu przez Safari aplikac…27999 tokens truncated…ry tworzy tymczasowy katalog z fałszywym `node_modules`, częściowym `dist` oraz plikami roboczymi i sprawdza, że `scripts/release-zip.cjs` nie pakuje ich do ZIP-a.
